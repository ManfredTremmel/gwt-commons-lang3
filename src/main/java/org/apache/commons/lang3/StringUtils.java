 ...
 *  <li>whitespace - the characters defined by {@link CharUtils#isWhitespace(char)}</li>
...
public class StringUtils {
    ...
    // Whitespace:
    // CharUtils.isWhitespace() is faster than WHITESPACE.indexOf()
    ...
    public static String stripStart(final String str, final String stripChars) {
        ...
        int start = 0;
        if (stripChars == null) {
            while (start != strLen && CharUtils.isWhitespace(str.charAt(start))) {
                start++;
            }
    ...
    public static String stripEnd(final String str, final String stripChars) {
        ...
        if (stripChars == null) {
            while (end != 0 && CharUtils.isWhitespace(str.charAt(end - 1))) {
                end--;
            }
        } else if (stripChars.isEmpty()) {
            return str;
    ...
    public static boolean containsWhitespace(final CharSequence seq) {
        ...
        for (int i = 0; i < strLen; i++) {
            if (CharUtils.isWhitespace(seq.charAt(i))) {
                return true;
            }
        }
        return false;
   ...
   public static String replaceIgnoreCase(final String text, final String searchString, final String replacement) {
    ...
    public static String uncapitalize(final String str) {
        ...
        final int firstCodepoint = str.codePointAt(0);
        final int newCodePoint = Character.toLowerCase((char) firstCodepoint);
        if (firstCodepoint == newCodePoint) {
            // already capitalized
            return str;
        }
    ...
    public static String abbreviate(final String str, final String abbrevMarker, int offset, final int maxWidth) {
        ...
        if (maxWidth < minAbbrevWidth) {
            throw new IllegalArgumentException(StringUtils.simpleFormat("Minimum abbreviation width is %d", minAbbrevWidth));
        }
        if (str.length() <= maxWidth) {
            return str;
        }
        ...
        if (maxWidth < minAbbrevWidthOffset) {
            throw new IllegalArgumentException(StringUtils.simpleFormat("Minimum abbreviation width with offset is %d", minAbbrevWidthOffset));
        }
    ...
    public static String normalizeSpace(final String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final boolean isWhitespace = CharUtils.isWhitespace(actualChar);
            if (!isWhitespace) {
    ...
    /**
     * Simple replacement for String.format(), works only with %s but it's enough for logging or exceptions.
     *
     * @param  format
     ...
     */
    public static String simpleFormat(final String format, final Object... args) {
