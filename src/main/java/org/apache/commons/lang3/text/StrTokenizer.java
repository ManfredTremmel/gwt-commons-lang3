...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    Object cloneReset() throws CloneNotSupportedException {
        ...
        cloned.ignoreEmptyTokens = this.ignoreEmptyTokens;

        cloned.delimMatcher = this.delimMatcher;
        cloned.quoteMatcher = this.quoteMatcher;
        cloned.ignoredMatcher = this.ignoredMatcher;
        cloned.trimmerMatcher = this.trimmerMatcher;
